...
const BBBStreamURL =
  "https://archive.org/serve/BigBuckBunny_328/BigBuckBunny_512kb.mp4";
...
const ContentView: React.FunctionComponent = () => {
  ...
  const gestureToPlayerInputMapperServiceRef =
    React.useRef<GestureToPlayerInputMapperService>();
  ...
  React.useEffect(() => {
    if (
      ...
      const gestureToPlayerInputMapperService =
        new GestureToPlayerInputMapperService(videoPlayer);
      ...
      gestureToPlayerInputMapperServiceRef.current =
        gestureToPlayerInputMapperService;
  ...
  return (
    <StyledAppDiv>
      <VideoPlayer
        ref={videoPlayerRef}
        mp4StreamURL={BBBStreamURL}
        width="500px"
        height="500px"
      />
      <p>
        Issue player commands by pinching the index finger and thumb and draw a
